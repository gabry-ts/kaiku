    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Work from any app, even when mc.Rofone is in the background. A bookmark is added instantly; you can label it in the panel or later in the library.")
            }
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                HStack {
                    Text("macOS asks for permission the first time you record. If the other side is missing from transcripts, allow mc.Rofone under System Audio Recording.")
...
struct CallDetectionSection: View {
    ...
    var body: some View {
        Section {
            ...
            Text("mc.Rofone watches which apps use a microphone, without opening any microphone itself. When Zoom, Teams, Meet and others start a call, you get a notification to record it.")
        }
...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 14) {
            ...
            VStack(spacing: 4) {
                Text("mc.Rofone").font(.system(size: 26, weight: .bold, design: .rounded))
