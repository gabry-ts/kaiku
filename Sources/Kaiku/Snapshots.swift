...
/// `Kaiku --render-snapshots <dir>` renders the main screens with sample data,
/// in light and dark mode, so the UI can be reviewed without clicking through it.
/// `Kaiku --render-icon <dir>` writes AppIcon.iconset and AppIcon.icns.
...
enum Snapshots {
    static func render(to dir: URL) -> Int32 {
        ...
        let defaults = UserDefaults(suiteName: "com.gabrielepartiti.kaiku.snapshots")!
        AppSettings.defaults = defaults
        AppSettings.registerDefaults()
        AppSettings.displayBaseFolderOverride = "~/Documents/Kaiku"
        ...
        defaults.register(defaults: [
            ...
            Keys.webhookURL: "https://hooks.example.com/kaiku",
