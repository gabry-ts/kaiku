...
/// log show --last 1h --info --predicate 'subsystem == "com.gabrielepartiti.mcrofone"'
enum Log {
    static let audio = Logger(subsystem: "com.gabrielepartiti.mcrofone", category: "audio")
    static let transcription = Logger(subsystem: "com.gabrielepartiti.mcrofone", category: "transcription")
    static let app = Logger(subsystem: "com.gabrielepartiti.mcrofone", category: "app")
}
