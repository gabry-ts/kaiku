...
/// Downloads ggml models with progress into ~/Library/Application Support/Kaiku/models.
@MainActor
final class WhisperModels: NSObject, ObservableObject, URLSessionDownloadDelegate {
    ...
    nonisolated static var directory: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Application Support/Kaiku/models", isDirectory: true)
    }
