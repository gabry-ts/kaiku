    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                Button(step == steps - 1 ? "Start Using mc.Rofone" : "Continue") {
                    if step == steps - 1 {
...
private struct WelcomeStep: View {
    var body: some View {
        VStack(spacing: 22) {
            ...
            StepHeader(symbol: nil, title: "Welcome to mc.Rofone",
    ...
    var body: some View {
        VStack(spacing: 22) {
            StepHeader(symbol: "lock.shield", title: "A few permissions",
                       subtitle: "mc.Rofone only listens while you're recording.")
            VStack(spacing: 12) {
